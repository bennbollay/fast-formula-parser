...
const toFullWidth = (str0) => sets.reduce((str, set) => str.replace(re(set, 'half'), toFull(set)), str0);
const toHalfWidth = (str0) => sets.reduce((str, set) => str.replace(re(set, 'full'), toHalf(set)), str0);
