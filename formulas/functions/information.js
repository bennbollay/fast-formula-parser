...
const InfoFunctions = {
  ...
  N: (value) => {
    ...
    else if (type === 'boolean') return Number(value);
    else if (value instanceof FormulaError) throw value;
    return 0;
  },
  ...
  TYPE: (value) => {
    ...
    else if (type === 'string') return 2;
    else if (type === 'boolean') return 4;
    else if (value instanceof FormulaError) return 16;
    else if (Array.isArray(value)) return 64;
  },
};
